...
i = 0
  ...
  gamestate.me.b = love.physics.newBody(world, 400,200, "dynamic")  -- set x,y position (400,200) and let it move and hit other objects ("dynamic")
  gamestate.me.b:setMass(10)                                        -- make it pretty light
  gamestate.me.s = love.physics.newCircleShape(16)                  -- give it a radius of 50
  gamestate.me.f = love.physics.newFixture(ball.b, ball.s)          -- connect body to shape
  gamestate.me.f:setRestitution(0.4)                                -- make it bouncy
  gamestate.me.f:setUserData("Ball") 
